...
ALL_IMAGES := \
	v0.12/alpine-elasticsearch:v0.12.40-elasticsearch,v0.12-elasticsearch,stable-elasticsearch,elasticsearch \
	v0.12/alpine-loggly:v0.12.40-loggly,v0.12-loggly,stable-loggly,loggly \
	v0.12/alpine-logentries:v0.12.40-logentries,v0.12-logentries,stable-logentries,logentries \
	v0.12/alpine-cloudwatch:v0.12.40-cloudwatch,v0.12-cloudwatch,stable-cloudwatch,cloudwatch \
	v0.12/alpine-s3:v0.12.40-s3,v0.12-s3,stable-s3,s3 \
	v0.12/debian-elasticsearch:v0.12.40-debian-elasticsearch,v0.12-debian-elasticsearch,debian-elasticsearch \
	v0.12/debian-loggly:v0.12.40-debian-loggly,v0.12-debian-loggly,debian-loggly \
	v0.12/debian-logentries:v0.12.40-debian-logentries,v0.12-debian-logentries,debian-logentries \
	v0.12/debian-cloudwatch:v0.12.40-debian-cloudwatch,v0.12-debian-cloudwatch,debian-cloudwatch \
	v0.12/debian-stackdriver:v0.12.40-debian-stackdriver,v0.12-debian-stackdriver,debian-stackdriver \
	v0.12/debian-s3:v0.12.40-debian-s3,v0.12-debian-s3,debian-s3
